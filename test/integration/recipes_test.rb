...
class RecipesTest < ActionDispatch::IntegrationTest
  ...
  test "should get recipes listin" do
    get recipes_path
  ...
  test "create new valid recipe" do
    ...
    description_of_recipe = "add chicken, add vegitables, cook for 20 minutes, serve delicious meal"
  ...
  test "reject new valid submissions" do
    get new_recipe_path
    assert_template 'recipes/new'
